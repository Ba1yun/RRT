...
class RRT:
    ...
    def __init__(self, obstacleList, randArea,
                 expandDis=2.0, goalSampleRate=50, maxIter=200):
    ...
    def get_new_node(self, theta, n_ind, nearestNode):
        ...
        if random.randint(0, 100) > mubiao_rate:
            ...
            if p>k:
                ...
                newNode.x += (d * math.cos(theta))
                newNode.y += (d * math.sin(theta))
            else:
                newNode.x += 0
                newNode.x += 0
        else:
    ...
    def draw_graph_informed_RRTStar(self, xCenter=None, cBest=None, cMin=None, e_theta=None, rnd=None, path=None):
        ...
        plt.title(u"path planning",fontproperties=my_font,fontsize=16)
...
def main():
    ...
    #obstacleList = [(5, 5, 0.5), (3, 6, 0.3), (3, 8, 0.2), (3, 10, 0.7), (7, 5, 0.8),
                    # (9, 5, 0.5), (8, 10, 0.2),(2, 2, 0.8),(10,12,0.1),
                   ## (8,3,0.5),(4,4,0.3),(9,2,0.5),(1,7,0.6),(5,1,0.1),
                   # (4,1,0.2),(4,2,0.5),(0,10,0.5),(1,12,0.8),(-1,4,0.5),
                   # (17,12,0.8),(11,11,0.5),(12,14,0.5),(7,10,0.8),(5,2,0.5),
                    #(15,2,0.9),(5,10,0.6),(13,4,0.8),(14,6,0.8)]
